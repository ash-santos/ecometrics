...
class RecommendationMonthlyActivity : AppCompatActivity(), OffsetActivityAdapter.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        FirebaseQuery().readOffsetActivity() { offsetActivity ->
            ...
            val adapter = OffsetActivityAdapter(offsetList, this, this@RecommendationMonthlyActivity)
