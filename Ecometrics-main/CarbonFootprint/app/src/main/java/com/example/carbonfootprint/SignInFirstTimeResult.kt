...
data class EmissionHighLevel(
    val category: String,
    val emission: Double,
    val percentEmission: String,
    val resourceID: Int
)

class SignInFirstTimeResult : AppCompatActivity() {
            ...
            FirebaseQuery().readUserInitialEmission(it) { emission ->
                ...
                if (houseEmission > 0) {
                    ...
                    val emissionPercent = if(percentageFormat == 100.00){
                        percentageFormat.toInt().toString()
                    }else{
                ...
                "Travel" -> {
                    user?.let {
                        FirebaseQuery().readUserInitialEmission(it) { emission ->
                            ...
                            var pUBEmission = emission.pubeEmission
