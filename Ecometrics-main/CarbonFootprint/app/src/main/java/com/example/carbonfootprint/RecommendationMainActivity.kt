...
import com.example.carbonfootprint.databinding.RecommendationsMainBinding
...
class RecommendationMainActivity : AppCompatActivity(), OffsetActivityAdapter.OnItemClickListener  {

    private lateinit var binding: RecommendationsMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = RecommendationsMainBinding.inflate(layoutInflater)
        ...
        FirebaseQuery().readOffsetActivity() { offsetActivity ->
            ...
            val adapter = OffsetActivityAdapter(offsetList, this, applicationContext)
        ...
        binding.btnOption.setOnClickListener {
            if (binding.btnOption.text == "Offset Activity") {
                binding.btnOption.text = "Recommendations"
                binding.tblTitleActivity.visibility = View.VISIBLE
                binding.tblRecommendation.visibility = View.GONE
            } else {
                binding.btnOption.text = "Offset Activity"
                binding.tblTitleActivity.visibility = View.GONE
                binding.tblRecommendation.visibility = View.VISIBLE
            }
        }
