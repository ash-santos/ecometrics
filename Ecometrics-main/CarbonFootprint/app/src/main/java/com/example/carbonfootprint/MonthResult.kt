...
class MonthResult : AppCompatActivity() {
    lateinit var binding: FirstTimeSignInResultBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = FirstTimeSignInResultBinding.inflate(layoutInflater)
        ...
        user?.let {
            FirebaseQuery().readUserMonthlyEmission(it, year, currentMonth) { emission ->

                var houseEmission = emission.houseEmission

                var foodEmission = emission.foodEmission

                var vehicleEmission = emission.vehicleEmission

                var travelEmission = emission.travelEmission
                ...
                if (houseEmission > 0) {
                    val emissionPercent = "${"%.2f".format((houseEmission / total) * 100)}%"
                ...
                if (foodEmission > 0) {
                    val emissionPercent = "${"%.2f".format((foodEmission / total) * 100)}%"
                ...
                if (vehicleEmission > 0) {
                    val emissionPercent = "${"%.2f".format((vehicleEmission / total) * 100)}%"
                ...
                if (travelEmission > 0) {
                    val emissionPercent = "${"%.2f".format((travelEmission / total) * 100)}%"
                    ...
                    user?.let {
                        FirebaseQuery().readUserInitialEmission(it) { emission ->
                            ...
                            if (electricityEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((electricityEmission / houseEmission) * 100)}%"
                            ...
                            if (charcoalEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((charcoalEmission / houseEmission) * 100)}%"
                            ...
                            if (lpgEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((lpgEmission / houseEmission) * 100)}%"
                            ...
                            if (firewoodEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((firewoodEmission / houseEmission) * 100)}%"
                ...
                "Food" -> {
                    user?.let {
                        FirebaseQuery().readUserInitialEmission(it) { emission ->
                            ...
                            if (meatEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((meatEmission / foodEmission) * 100)}%"
                            ...
                            if (fishEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((fishEmission / foodEmission) * 100)}%"
                            ...
                            if (crustaceansEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((crustaceansEmission / foodEmission) * 100)}%"
                            ...
                            if (mollusksEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((mollusksEmission / foodEmission) * 100)}%"
                    ...
                    user?.let {
                        FirebaseQuery().readUserInitialEmission(it) { emission ->
                            ...
                            if (premiumEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((premiumEmission / vehicleEmission) * 100)}%"
                            ...
                            if (unleadedEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((unleadedEmission / vehicleEmission) * 100)}%"
                            ...
                            if (dieselEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((dieselEmission / vehicleEmission) * 100)}%"
                ...
                "Travel" -> {
                    user?.let {
                        FirebaseQuery().readUserInitialEmission(it) { emission ->
                            ...
                            var pUJEmission = emission.pujEmission
                            var ePUJEmission = emission.epujEmission
                            var ePUJAEmission = emission.epujaEmission
                            var pUBEmission = emission.pubEmission
                            var pUBAEmission = emission.pubaEmission
                            var pUBEEmission = emission.pubeEmission
                            var taxiEmission = emission.taxiEmission
                            var uVExpressEmission = emission.uvexpressEmission
                            ...
                            if (tricycleEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((tricycleEmission / travelEmission) * 100)}%"
                            ...
                            if (pUJEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((pUJEmission / travelEmission) * 100)}%"
                            ...
                            if (ePUJEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((ePUJEmission / travelEmission) * 100)}%"
                            ...
                            if (ePUJAEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((ePUJAEmission / travelEmission) * 100)}%"
                            ...
                            if (pUBEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((pUBEmission / travelEmission) * 100)}%"
                            ...
                            if (pUBEEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((pUBEEmission / travelEmission) * 100)}%"
                            ...
                            if (pUBAEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((pUBAEmission / travelEmission) * 100)}%"
                            ...
                            if (taxiEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((taxiEmission / travelEmission) * 100)}%"
                            ...
                            if (uVExpressEmission > 0) {
                                val emissionPercent =
                                    "${"%.2f".format((uVExpressEmission / travelEmission) * 100)}%"
        ...
        binding.btnShowRecommendation.setOnClickListener {
            val intent = Intent(this, RecommendationMonthlyActivity::class.java)
